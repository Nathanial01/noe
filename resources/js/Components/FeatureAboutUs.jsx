      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            <h2 className="text-pretty text-2xl font-semibold tracking-tight  text-gray-900 dark:text-gray-100">Our mission</h2>
            <p className="mt-6 text-base/7 t text-gray-600 dark:text-gray-300">
            ...
            <p className="mt-8 text-base/7text-gray-600 dark:text-gray-300">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
                ...
                <dd className="order-first text-6xl text-gray-600 dark:text-gray-300 font-semibold tracking-tight">
                  $<span className="text-gray-900 dark:text-gray-100">150</span>M
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
                ...
                <dd className="order-first text-6xl font-semibold tracking-tight text-gray-600 dark:text-gray-300">
                  <span className="text-gray-900 dark:text-gray-100">30</span>K
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-200 max-sm:pb-4">
                <dt className="text-sm/6 text-gray-600 dark:text-gray-300">Deals Closed</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-gray-600 dark:text-gray-300">
                  <span className="text-gray-900 dark:text-gray-100">1.5</span>M
                </dd>
              </div>
              <div className="flex flex-col gap-y-2">
                <dt className="text-sm/6 text-gray-600 dark:text-gray-300">Leads Generated</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-gray-600 dark:text-gray-300">
                  <span className="text-gray-900 dark:text-gray-100">200</span>M
                </dd>
              </div>
            </dl>
          </div>
