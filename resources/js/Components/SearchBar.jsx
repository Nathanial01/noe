...
const SearchBar = () => {
    ...
    const fetchResults = useCallback(async () => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/search`,
                { query },
                { withCredentials: true } // ✅ Add credentials for CSRF token
            );
    ...
    return (
        <div className="relative">
            {/* Search Bar */}
            <div className="p-5 h-10 rounded-full flex group items-center duration-300 bg-gray-600/80 backdrop-blur-3xl">
                {/* Search Icon */}
                ...
                <input
                    ...
                    className="outline-none bg-transparent border-0 w-full px-4 focus:ring-0"
                    value={query}
