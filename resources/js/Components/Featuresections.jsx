  ...
  return (
    <div className="bg-none py-24 sm:py-32 mt-2 w-full">
      <div className="flex flex-col sm:flex-row items-center w-full px-6 gap-24 justify-evenly">
        {/* Text Section */}
        <div
          className="w-full sm:w-1/2 text-left text-white font-poppins font-semibold leading-normal"
          style={{
        ...
        <div className="w-full sm:w-1/2 ml-auto  transform translate-x-40 mt-16">
          <LottieBackground />
        </div>
      </div>
