...
const navigation = {
    ABOUT: [
        { name: "Marketing", href: "/UnderConstruction" },
        { name: "Analytics", href: "/UnderConstruction" },
        { name: "Automation", href: "/UnderConstruction" },
        { name: "Commerce", href: "/UnderConstruction" },
        { name: "Insights", href: "/UnderConstruction" },
    ],
    APPROACH: [
        { name: "Documentation", href: "/UnderConstruction" },
        { name: "Guides", href: "/UnderConstruction" },
    ],
    company: [
        { name: "About", href: "/UnderConstruction" },
        { name: "Blog", href: "/UnderConstruction" },
        { name: "Jobs", href: "/UnderConstruction" },
    ],
    INVEST: [
        { name: "Terms of service", href: "/UnderConstruction" },
        { name: "Privacy policy", href: "/UnderConstruction" },
        { name: "License", href: "/UnderConstruction" },
    ],
    CAREERS: [
        { name: "Marketing", href: "/UnderConstruction" },
        { name: "Analytics", href: "/UnderConstruction" },
    ...
    Privacy: [
        { name: "Terms of service", href: "/UnderConstruction" },
        { name: "Privacy policy", href: "/UnderConstruction" },
        { name: "Terms of Use", href: "/UnderConstruction" },
    ],
    INSIGHTS: [
        {
            name: "Facebook",
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
                ...
                <div className="mt-8 border-t dark:border-white/20 border-black/20 pt-8 md:flex md:items-center md:justify-between">
                    ...
                    <p className="mt-8 text-sm/6 text-gray-200 md:order-1 md:mt-0">
                        &copy; 2024 Noé Capital, Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
