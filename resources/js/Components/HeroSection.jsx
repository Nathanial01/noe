...
export default function HeroSection() {
  return (
    <section className="container mx-auto relative h-screen flex flex-col justify-start items-start right-60">
      {/* Hero Text Container */}
      <div className="relative text-center">
        {/* "Make your" positioned at the top */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[64px] font-semibold leading-tight bg-clip-text text-transparent drop-shadow-md font-[Poppins] bg-[linear-gradient(90deg,#FFF_58%,#7344B8_100%)]">
          Make your
        </h1>

        {/* Main Text - Dre am */}
        <div className="flex items-center justify-center gap-2 sm:gap-4 lg:gap-6">
          <h1 className="text-[80px] sm:text-[150px] md:text-[250px] lg:text-[300px] font-black leading-tight font-[Poppins] bg-clip-text text-transparent bg-[linear-gradient(287deg,#581CAF_22.12%,#BEB0D1_44.63%,#FFF_66.82%)]">
            Dre
          </h1>
          <h1 className="text-[80px] sm:text-[150px] md:text-[250px] lg:text-[300px] font-black leading-tight font-[Poppins] bg-clip-text text-transparent bg-[linear-gradient(282deg,#F1AB4F_-0.07%,#581CAF_85.35%)]">
            am
          </h1>
        </div>

        {/* "Come true!" Element */}
        <h2 className="mt-4 text-4xl sm:text-6xl md:text-7xl lg:text-[120px] font-semibold text-center font-[Poppins] bg-clip-text text-transparent bg-[linear-gradient(90deg,#5B1FAD_0%,#FC0_100%)]">
          Come true!
        </h2>
      </div>
    </section>
