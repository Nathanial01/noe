    ...
    return (
                ...
                <div className=" rounded-lg flex flex-col lg:flex-row max-w-6xl w-full overflow-hidden   ">
                    <div className="w-full rounded-lg lg:w-1/3 z-10 backdrop-blur-3xl  text-gray-50 p-8 flex flex-col justify-between">
                        ...
                        <div className="mt-12 mb-24">
                            <p className="font-semibold  text-gray-50 text-gray-50">
                                Onze Locatie:
                            </p>
                            <iframe
        ...
        ></textarea>
                            ...
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="privacy_policy" className="text-white text-sm ml-3">
                            ...
                            <button className="group relative flex items-center justify-center w-full h-14 px-5 rounded-full font-semibold text-white uppercase bg-transparent border-0 overflow-hidden transition-all duration-300 ease-in-out z-10">
